    ...
    'queues': [
        ...
        },
        {
            ...
            'output': [
                ...
                (('dt_vol_Innovative Distribution', 1), (16, 1)),
                (('dt_vol_Regular Distribution', 1), (16, 0)),
...
aab ={
            ...
            'parameters': {
                # Due to Demographics.
                '1': {'delay': 1},
                '2': {'delay': ('timeline_parameters', 0), 'sensitivity': 1, 'imp_type': 'linear', 'var_type': 'abs'},
                # Due to Economy.
                '3': {'delay': 1},
                '4': {'delay': ('timeline_parameters', 0), 'sensitivity': ('coefficients', 0), 'imp_type': 'linear', 'var_type': 'abs'},
                # Due to Unit Size changes.
                '5': {'delay': 1},
                '6': {'delay': ('timeline_parameters', 0), 'sensitivity': ('coefficients', 4), 'imp_type': 'exp', 'var_type': 'abs'},
                '7': {'delay': ('timeline_parameters', 0), 'sensitivity': ('coefficients', 4), 'imp_type': 'linear', 'var_type': 'abs'},
                # Due to Inflation.
                '8': {'delay': 1},
                '9': {'delay': ('timeline_parameters', 0), 'sensitivity': 1, 'imp_type': 'linear', 'var_type': 'abs'},
                # Due to Premiumization.
                '10': {'delay': 1},
                '11': {'delay': ('timeline_parameters', 0), 'sensitivity': 1, 'imp_type': 'linear', 'var_type': 'abs'},
                # Due to Advertizing.
                '12': {'delay': 1},
                '13': {'delay': ('timeline_parameters', 0), 'sensitivity': ('coefficients', 5), 'imp_type': 'linear', 'above_count': 1},
                # Due to distribution.
                '14': {'delay': 1},
                '15': {'delay': 1},
                '16': {'delay': ('timeline_parameters', 0), 'regular_sensitivity': ('coefficients', 2), 'innovations_sensitivity': ('coefficients', 1)},
                # Delay for Volume sold as promo.
                '17': {'delay': 1},
                # Due to Discount.
                '18': {'delay': 1},
                '19': {'sensitivity': ('coefficients', 6), 'imp_type': 'linear', 'var_type': 'rate'},
                '20': {},
                '21': {'delay': ('timeline_parameters', 0)},
                # Due to Promo Support.
                '22': {'delay': 1},
                '23': {'sensitivity': ('coefficients', 6), 'imp_type': 'linear', 'var_type': 'rate'},
                '24': {},
                '25': {'delay': ('timeline_parameters', 0)},
                # Due to Price.
                '26': {'delay': 1},
                '27': {'delay': ('timeline_parameters', 0), 'sensitivity': ('coefficients', 3)},
                # Due to Other Pricing drivers
                '28': {},
                '29': {'delay': 1},
                '30': {},
            ...
            'input_pins': {
                ...
                '35': [('inp', 3, True)],
                '36': [('35', 0, True), ('36', 0, False)],
                '37': [('34', 0, True), ('36', 0, True)],
                # Sales Value
                '38': [('37', 0, True), ('28', 0, True)],
                # Sales Units
                '39': [('38', 0, True), ('inp', 5, True)]
            },
            'output': [
                (('Value', 1), ('37', 0)),
                (('EQ Volume', 1), ('36', 0)),
